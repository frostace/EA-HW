...
std::vector<float> k_spring = {1000, 20000, 5000, 5000, 0};
std::vector<float> b_spring = {0, 0, 0.25, 0.25, 0};
std::vector<float> c_spring = {0, 0, 0, pi, 0};
std::vector<std::vector<float>> cube_colors = {
    // types:                    color           |  k         | b     | c
    {0.172f, 0.243f, 0.313f}, // midnight blue      1,000       0       0
    {0.584f, 0.647f, 0.651f}, // concrete           20,000      0       0
    {0.153f, 0.682f, 0.376f}, // nephritis          5,000       0.25    0
    {0.906f, 0.298f, 0.235f}, // alizarin           5,000       0.25    pi
