...
public:
    ...
    void settle()
    {
        ...
        while (frameNum < 250) // 10 cycles + 8
        {
            frameNum += 1;
            iterate(false);
        }
        // TODO: modified on 12-01
        // while (frameNum < 450) // 10 cycles + 8
        // {
        //     frameNum += 1;
        //     iterate();
        // }
    ...
    void measurePerformance()
    {
        ...
        int frameNum = 0;
        // Loop for several iterations and measure X distance at the end
        while (frameNum < 100) // 2 cycles
        {
            frameNum += 1;
            iterate();
        }
        fitness = scaledCentroidZ * scaledCentroidX;
    }
